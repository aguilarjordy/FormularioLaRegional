...
export default function FormularioRegistro() {
  ...
  return (
    <div className="bg-warning-subtle min-vh-100 d-flex align-items-center justify-content-center p-4">
      <ToastContainer />
        ...
        <div className="card-body">
          <div className="text-center mb-4">
            <img
              src="/logo.png"
              alt="La Regional"
              className="mb-3 rounded-circle border border-warning-subtle"
              style={{ width: "90px" }}
            />
            <h3 className="fw-bold text-warning-emphasis">La Regional contigo</h3>
